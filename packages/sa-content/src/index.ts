...
export const DURBAN_AREAS = ['umlazi', 'chatsworth', 'phoenix', 'kwa_mashu', 'point', 'cbd'] as const;
...
export const SLANG: Array<{ term: string; meaning: string; register: 'street' | 'casual' | 'tsotsitaal' }> = [
...
export const SURNAMES = [
  'Mokoena', 'Dlamini', 'Khumalo', 'Naidoo', 'van der Merwe',
  'Pillay', 'Botha', 'Ndlovu', 'Mahlangu', 'Sithole',
  'du Plessis', 'Mbeki', 'Nkosi', 'Pretorius', 'Cele',
  'Mthembu', 'Zulu', 'de Klerk', 'Moodley', 'Tshabalala',
];

export const FIRST_NAMES = {
  m: ['Sipho', 'Thabo', 'Pieter', 'Bongani', 'Andile', 'Lwazi', 'Kagiso', 'Vusi', 'Rohan', 'Mandla'],
  f: ['Nomvula', 'Lerato', 'Anika', 'Zinhle', 'Palesa', 'Naledi', 'Refilwe', 'Karabo', 'Buhle', 'Thandi'],
};
